...
#include <WulfNet/Jolt/Core/JobSystemSingleThreaded.h>
#include <WulfNet/Jolt/Core/TempAllocator.h>
#include <WulfNet/Jolt/Core/StreamWrapper.h>
#include <WulfNet/Jolt/Core/StringTools.h>
#include <WulfNet/Jolt/Geometry/OrientedBox.h>
#include <WulfNet/Jolt/Compute/CPU/ComputeSystemCPU.h>
#include <WulfNet/Jolt/Physics/PhysicsSystem.h>
#include <WulfNet/Jolt/Physics/StateRecorderImpl.h>
#include <WulfNet/Jolt/Physics/Body/BodyCreationSettings.h>
#include <WulfNet/Jolt/Physics/SoftBody/SoftBodyMotionProperties.h>
#include <WulfNet/Jolt/Physics/SoftBody/SoftBodyCreationSettings.h>
#include <WulfNet/Jolt/Physics/PhysicsScene.h>
#include <WulfNet/Jolt/Physics/Collision/RayCast.h>
#include <WulfNet/Jolt/Physics/Collision/ShapeCast.h>
#include <WulfNet/Jolt/Physics/Collision/CastResult.h>
#include <WulfNet/Jolt/Physics/Collision/CollidePointResult.h>
#include <WulfNet/Jolt/Physics/Collision/AABoxCast.h>
#include <WulfNet/Jolt/Physics/Collision/CollisionCollectorImpl.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/HeightFieldShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/MeshShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/SphereShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/BoxShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/ConvexHullShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/CapsuleShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/TaperedCapsuleShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/CylinderShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/TaperedCylinderShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/TriangleShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/PlaneShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/RotatedTranslatedShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/StaticCompoundShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/MutableCompoundShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/ScaledShape.h>
#include <WulfNet/Jolt/Physics/Collision/Shape/EmptyShape.h>
#include <WulfNet/Jolt/Physics/Collision/NarrowPhaseStats.h>
#include <WulfNet/Jolt/Physics/Collision/CollideSoftBodyVertexIterator.h>
#include <WulfNet/Jolt/Physics/Constraints/DistanceConstraint.h>
#include <WulfNet/Jolt/Physics/Constraints/PulleyConstraint.h>
#include <WulfNet/Jolt/Physics/Character/CharacterVirtual.h>
...
bool SamplesApp::UpdateFrame(float inDeltaTime)
{
	...
	else
	{
		...
		// Always repopulate debug geometry when the frame is active (inDeltaTime > 0).
		// Application::RenderFrame() clears the debug renderer every frame when
		// world_delta_time > 0 (which is every non-paused frame with UnlockFrameRate).
		// Without this, frames between physics steps would render empty geometry,
		// causing visible "flashing" at render rates above the physics rate (60 Hz).
		if (inDeltaTime > 0.0f)
		{
			DrawPhysics();
