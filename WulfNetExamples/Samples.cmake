# Root
set(SAMPLES_ROOT ${PHYSICS_REPO_ROOT}/WulfNetExamples)

# Source files
set(SAMPLES_SRC_FILES
	${SAMPLES_ROOT}/SamplesLayers.h
...
target_link_libraries(Samples LINK_PUBLIC WulfNetFramework WulfNet)
target_precompile_headers(Samples PUBLIC ${SAMPLES_ROOT}/Samples.h)

# Place Samples.exe at the repository root for easy access.
# AssetStream walks up from the exe looking for Assets/, which is at repo root.
