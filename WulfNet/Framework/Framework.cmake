if (NOT CROSS_COMPILE_ARM AND (JPH_USE_VK OR JPH_USE_DX12 OR JPH_USE_MTL))
	# We have Vulkan/DirectX/Metal so we can compile WulfNetFramework
	set(TEST_FRAMEWORK_AVAILABLE TRUE)

	# Root
	set(TEST_FRAMEWORK_ROOT ${PHYSICS_REPO_ROOT}/WulfNet/Framework)
	...
	set(TEST_FRAMEWORK_SRC_FILES
		...
		${TEST_FRAMEWORK_ROOT}/Framework.cmake
		${TEST_FRAMEWORK_ROOT}/Framework.h
	...
	# Create WulfNetFramework lib
	add_library(WulfNetFramework STATIC ${TEST_FRAMEWORK_SRC_FILES} ${TEST_FRAMEWORK_SRC_FILES_SHADERS} ${TEST_FRAMEWORK_GLSL_SHADERS} ${TEST_FRAMEWORK_SPV_SHADERS} ${TEST_FRAMEWORK_METAL_SHADERS} ${TEST_FRAMEWORK_METAL_LIB})
	target_include_directories(WulfNetFramework PUBLIC ${TEST_FRAMEWORK_ROOT})
	target_precompile_headers(WulfNetFramework PUBLIC ${TEST_FRAMEWORK_ROOT}/Framework.h)

	if (WIN32)
		# Windows configuration
		target_link_libraries(WulfNetFramework LINK_PUBLIC Jolt dinput8.lib shcore.lib dxguid.lib)
	endif()
	if (LINUX)
		# Linux configuration
		target_link_libraries(WulfNetFramework LINK_PUBLIC Jolt X11)
	endif()
	if (APPLE)
		# macOS configuration
		target_link_libraries(WulfNetFramework LINK_PUBLIC Jolt "-framework Cocoa -framework GameController")
		...
		foreach(ASSET_FILE ${TEST_FRAMEWORK_ASSETS})
			...
			string(REPLACE ${PHYSICS_REPO_ROOT}/WulfNet/Jolt "Resources/WulfNet/Jolt" ASSET_DST ${ASSET_DST})
