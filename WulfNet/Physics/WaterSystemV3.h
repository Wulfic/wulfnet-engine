...
class WaterSystemV3 {
public:
    WaterSystemV3(const WaterSystemV3Config& config, JPH::PhysicsSystem* physicsSystem);
    ~WaterSystemV3() = default;
    ...
    const WaterSystemV3Config& GetConfig() const { return m_config; }
