...
# Root
set(JOLT_PHYSICS_ROOT ${PHYSICS_REPO_ROOT}/WulfNet/Jolt)
		...
		elseif (NOT SPIRV_CROSS_COMPILER)
			...
			foreach(SHADER ${JOLT_PHYSICS_SHADERS})
				...
				add_custom_command(OUTPUT ${AIR_SHADER}
					COMMAND ${DXC_COMPILER} -E main -T cs_6_0 -I WulfNet/Jolt/Shaders -WX -O3 -all_resources_bound ${SHADER} -spirv -fvk-use-dx-layout -fspv-entrypoint-name=${SHADER_STEM} -Fo ${SPV_SHADER}
	...
	if (Vulkan_FOUND)
		...
		foreach(SHADER ${JOLT_PHYSICS_SHADERS})
			...
			add_custom_command(OUTPUT ${SPV_SHADER}
				...
				COMMAND ${Vulkan_dxc_EXECUTABLE} -E main -T cs_6_0 -I WulfNet/Jolt/Shaders -WX -O3 -all_resources_bound ${SHADER} -spirv -fvk-use-dx-layout -Fo ${SPV_SHADER}
				DEPENDS ${SHADER} ${JOLT_PHYSICS_SHADER_HEADERS} # Currently don't have a way to detect header dependencies, so making dependent on all
